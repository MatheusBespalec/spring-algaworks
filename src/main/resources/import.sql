insert into restaurant_category (name) values ("Brasileira"), ("Chinesa"), ("Indiana");

insert into restaurant (name, freight_rate, category_id, created_at, updated_at) values ("100 Miséria", 10, 1, utc_timestamp, utc_timestamp), ("LigLig", 12.5, 2, utc_timestamp, utc_timestamp), ("Tuk Tuk", 0, 3, utc_timestamp, utc_timestamp)
